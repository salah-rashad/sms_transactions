...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer2<TransactionProvider, MoneyPoolProvider>(
        builder: (context, txProvider, poolProvider, _) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    ElevatedButton(
                      onPressed: txProvider.loadTransactions,
          ...
          final totalSavings = poolProvider.totalContributed;
          final totalExpense = txProvider.rawExpense - totalSavings;
          final monthlyBreakdown = MonthlyBreakdown.compute(
            txProvider.transactions,
            poolProvider.contributions,
          );
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: StatsCard(
                          title: 'Balance',
                          value: CurrencyText(amount: txProvider.currentBalance, color: colors.balance),
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: StatsCard(
                          title: 'Income',
                          value: CurrencyText(amount: txProvider.totalIncome, color: colors.income),
                          color: colors.income,
                      ...
                      Expanded(
                        child: StatsCard(
                          title: 'Expense',
                          value: CurrencyText(amount: totalExpense, color: colors.expense),
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: StatsCard(
                          title: 'Savings (Pool)',
                          value: CurrencyText(amount: totalSavings, color: context.colorScheme.primary),
